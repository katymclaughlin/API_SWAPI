...
namespace IntroToApi.ConsoleApp
{
    class Program
    {
        ...
        //convert to a C# object using two different methods
            ...
            //var genericResponse = service.GetAsync<Vehicle>("http://swapi.dev/api/vehicles/4").Result;
            var genericResponse = service.GetAsync<Person>("http://swapi.dev/api/people/4").Result;
            ...
            var person2Response = service.GetPersonAsync("http://swapi.dev/api/people/5").Result;
